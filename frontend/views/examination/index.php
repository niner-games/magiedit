...
$this->title = Yii::t('frontend-views', 'Examinations');
...
<div class="examination-index">
    ...
    <p><?= Yii::t('frontend-views', 'The list of all examinations performed through the system is shown below.') ?></p>

    <p><?= Html::a(Yii::t('frontend-views', 'Add Examination'), ['create'], ['class' => 'btn btn-success']) ?></p>
